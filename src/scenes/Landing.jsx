        ...
        {isAboveMediumScreens ? (
          ...
          >
            <img
              ...
              className="hover:filter hover:saturate-10 transition duration-500 z-10 w-full max-w-[400px] md:max-w-[600px] rounded-full"
            />
          </div>
        ) : (
          <img
            alt="profile"
            src="../assets/profile-image.png"
            className="hover:filter transition duration-500 z-10 w-full max-w-[400px] md:max-w-[600px] rounded-full"
          />
        )}
      </div>
      {/* MAIN SECTION */}
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-10 text-sm text-center md:text">
            ...
            design, and a commitment to delivering high-quality user
